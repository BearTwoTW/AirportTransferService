...
export default function CityArea() {
    ...
    const edit_Confirm = () => {
        ...
        if (editData.updCms.name === null || editData.updCms.max_passengers === null || editData.updCms.max_luggage === null || editData.updCms.max_child_seats === null || editData.updCms.max_service_extras === null) {
            setEditDataCheck({
                name: editData.updCms.name === null ? true : false,
                max_passengers: editData.updCms.max_passengers === null ? true : false,
                max_luggage: editData.updCms.max_luggage === null ? true : false,
                max_child_seats: editData.updCms.max_child_seats === null ? true : false,
                max_service_extras: editData.updCms.max_service_extras === null ? true : false,
            });
        } else {
            setEditDataCheck(initEditDataCheck);

            ATS_CarModelSettings.ATS_CarModelSettingsUpdate(editData.updCms).then(res => {
                if (res.success) {
                    dialogClose();
                    searchCarModel({
                        ...pageSearch,
            ...
            <React.Fragment>
                ...
                <Grid item xs={12}>
                    <CusInput
                        ...
                        label={'乘車人數上限'}
                        type={'number'}
                        error={editDataCheck.max_passengers}
                ...
                <Grid item xs={12}>
                    <CusInput
                        ...
                        label={'行李數上限'}
                        type={'number'}
                        error={editDataCheck.max_luggage}
                ...
                <Grid item xs={12}>
                    <CusInput
                        ...
                        label={'安全座椅上限'}
                        type={'number'}
                        error={editDataCheck.max_child_seats}
                ...
                <Grid item xs={12}>
                    <CusInput
                        ...
                        label={'服務加成項目上限'}
                        type={'number'}
                        error={editDataCheck.max_service_extras}
